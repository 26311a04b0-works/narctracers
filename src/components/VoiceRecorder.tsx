...
const styles = StyleSheet.create({
  micButton: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 12, paddingVertical: 10, backgroundColor: Colors.navy[900], borderWidth: 1, borderColor: Colors.teal[500], borderRadius: 8 },
  micButtonActive: { backgroundColor: 'rgba(231, 76, 60, 0.15)', borderColor: Colors.red[500] },
  micText: { fontSize: 13, fontWeight: '600', color: Colors.teal[300], fontFamily: 'Inter-SemiBold' },
  micTextActive: { color: Colors.red[400] },
  errorRow: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 6 },
  errorText: { fontSize: 11, color: Colors.red[400], fontFamily: 'Inter-Regular' },
});
